...
type Shell interface {
	...
	SetPresenter(p presentation.Service)
...
//
// Context.Context is the per-command context created by the REPL. Handlers
// should pass it to every service call instead of using context.Background().
type Context struct {
