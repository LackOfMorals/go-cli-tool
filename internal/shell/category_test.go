...
func blankCtx() shell.Context {
	return shell.Context{Context: context.Background()}
}
...
func TestDispatch_NamedCommand(t *testing.T) {
	...
	c := newTestCategory("admin").
		AddCommand(&shell.Command{
			Name:    "show-users",
			Handler: func(_ []string, _ shell.Context) (string, error) { called = true; return "users", nil },
		})
...
func TestDispatch_NamedCommand_PassesRestArgs(t *testing.T) {
	...
	c := newTestCategory("root").
		AddCommand(&shell.Command{
			Name: "get",
			Handler: func(args []string, _ shell.Context) (string, error) {
				gotArgs = args
				return "", nil
			},
		})
...
func TestDispatch_DirectHandler_CalledWhenNoCommandMatches(t *testing.T) {
	var gotArgs []string
	c := newTestCategory("cypher").
		SetDirectHandler(func(args []string, _ shell.Context) (string, error) {
			gotArgs = args
			return "ok", nil
		})
...
func TestDispatch_Subcategory(t *testing.T) {
	...
	sub := newTestCategory("instances").
		AddCommand(&shell.Command{
			Name:    "list",
			Handler: func(_ []string, _ shell.Context) (string, error) { called = true; return "list", nil },
		})
...
func TestPrerequisite_BlocksDispatch(t *testing.T) {
	c := newTestCategory("admin").
		AddCommand(&shell.Command{
			Name:    "show-users",
			Handler: func(_ []string, _ shell.Context) (string, error) { return "ok", nil },
		}).
...
func TestPrerequisite_PassesWhenMet(t *testing.T) {
	...
	c := newTestCategory("admin").
		AddCommand(&shell.Command{
			Name:    "show-users",
			Handler: func(_ []string, _ shell.Context) (string, error) { called = true; return "ok", nil },
		}).
...
func TestPrerequisite_WrapsErrPrerequisite(t *testing.T) {
	...
	c := newTestCategory("test").
		AddCommand(&shell.Command{
			Name:    "cmd",
			Handler: func(_ []string, _ shell.Context) (string, error) { return "", nil },
		}).
		SetPrerequisite(func() error {
...
func TestDispatch_ContextPropagated(t *testing.T) {
	...
	sc := shell.Context{Context: ctx}

	var gotCtx context.Context
	c := newTestCategory("root").
		AddCommand(&shell.Command{
			Name: "check",
			Handler: func(_ []string, ctx shell.Context) (string, error) {
				gotCtx = ctx.Context
				return "", nil
			},
		})
